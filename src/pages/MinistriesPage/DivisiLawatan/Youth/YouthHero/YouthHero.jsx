...
const YouthHero = () => {
  const youthContact = "https://www.instagram.com/rock_bethkasih?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
    ...
    <div className='youth-hero-wrapper'>
        <div className='divisi-youth-header'>
            <div className='divisi-youth-content'>
                ...
                <a href={youthContact} className='btn-black'>Contact us</a>
            </div>
